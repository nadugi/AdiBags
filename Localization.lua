...
L["Consider gems as a subcategory of trade/crafting goods"] = true
L["Consider glyphs as a subcategory of trade/crafting goods"] = true
L["Equipment"] = true
...
L["Consider gems as a subcategory of trade/crafting goods"] = "Considère les gemmes comme une sous-catégorie d'artisanat."
L["Consider glyphs as a subcategory of trade/crafting goods"] = "Considère les glyphes comme une sous-catégorie d'artisanat."
...
L["Consider gems as a subcategory of trade/crafting goods"] = "Edelsteine als Unterkategorie von handelbaren Gegenständen betrachten"
L["Consider glyphs as a subcategory of trade/crafting goods"] = "Glyphen als Unterkategorie von handelbaren Gegenständen betrachten"
...
L["Consider gems as a subcategory of trade/crafting goods"] = "Рассматривать самоцветы как подкатегорию хозяйственных товаров"
L["Consider glyphs as a subcategory of trade/crafting goods"] = "Рассматривать символы как подкатегорию хозяйственных товаров"
...
L["Consider gems as a subcategory of trade/crafting goods"] = "Considerar gemas como subcategoria de objetos comerciables."
L["Consider glyphs as a subcategory of trade/crafting goods"] = "Considerar Glifos  como subcategoria de objetos comerciables."
...
L["Configure"] = "配置"
L["Consider gems as a subcategory of trade/crafting goods"] = "將寶石設定為商品的子類別"
L["Consider glyphs as a subcategory of trade/crafting goods"] = "將雕紋設定為商品的子類別"
...
L["Configure"] = "配置"
L["Consider gems as a subcategory of trade/crafting goods"] = "将珠宝设定为商品子类"
L["Consider glyphs as a subcategory of trade/crafting goods"] = "将雕文设定为商品子类"
...
L["All controls are disabled if the selected theme is the default theme. Make a new theme below to edit your theme."] = "선택한 테마가 기본 테마인 경우 모든 설정이 무효화 됩니다. 설정을 적용하려면 새 테마를 만드세요."
...
L["Are you sure you want to save and overwrite the theme '"] = "저장하고 덮어 쓰시겠습니까? '테마:"
L["Are you sure you want to delete the theme '"] = "삭제 하시겠습니까? '테마:"
L["Assign %s to ..."] = "%s|1을;를; 할당합니다: "
L["At merchants', bank, auction house, ..."] = "상점, 은행, 경매장에서..."
L["auto-deposit"] = "자동 보관"
L["Automatically..."] = "자동으로..."
...
L["Column width"] = "열 너비"
L["Configure"] = "설정"
L["Consider gems as a subcategory of trade/crafting goods"] = "보석을 직업 용품으로 간주합니다"
L["Consider glyphs as a subcategory of trade/crafting goods"] = "문양을 직업 용품으로 간주합니다"
L["Container information"] = "아이템 위치 정보"
L["Compact layout"] = "콤팩트한 레이아웃"
L["COOKING_BAR_TAG"] = "요리"
L["Currencies to show"] = "표시할 화폐"
L["Currency"] = "화폐"
L["Delete Theme"] = "테마 삭제"
L["Delete the selected theme from the database."] = "선택한 테마를 삭제합니다."
...
L["GEM_BAG_TAG"] = "보세"
L["Gems are trade/crafting goods"] = "보석을 직업 용품으로"
L["Glyphs are trade/crafting goods"] = "문양을 직업 용품으로"
L["HERB_BAG_TAG"] = "약초"
...
L["Highlight items that have changed"] = "변경된 항목 강조 표시"
...
L["Save Theme"] = "테마 저장"
L["Save the current theme settings to the selected theme name."] = "현재 테마 설정을 저장합니다.(선택한 테마 이름으로)"
L["Scale"] = "크기 비율"
L["Section"] = "항목"
L["Section layout"] = "항목 레이아웃"
...
L["Select the theme to use for displaying the bags."] = "가방에 사용할 테마를 선택하세요."
...
L["Split trade/crafting goods by expansion"] = "직업용품의 분류 확장"
L["TACKLE_BOX_TAG"] = "낚시"
L["Text"] = "문자"
L["Texture"] = "텍스쳐"
L["Theme"] = "테마"
L["Theme Controls"] = "테마 설정"
L["Theme Selection"] = "테마 선택"
...
L["Type in a new theme in the input below and hit enter to create a new theme."] = "새로운 테마를 만드려면 아래 입력란에 이름을 넣고 확인을 누르세요."
L["Type in the name of the new theme to create."] = "새로운 테마의 이름을 입력하세요."
...
L["When enabled, AdiBags reorder the section to achieve a more compact layout."] = "간결한 레이아웃을 보여줍니다."
...
L["Configure"] = "Configurar"
L["Consider gems as a subcategory of trade/crafting goods"] = "Considera gemas como uma subcategoria de bens de troca"
L["Consider glyphs as a subcategory of trade/crafting goods"] = "Considera glifos como uma subcategoria de bens de troca"
